...
ActiveRecord::Schema.define(version: 20140429004511) do
  ...
  add_index "post_shares", ["post_id", "friend_circle_id"], name: "index_post_shares_on_post_id_and_friend_circle_id", unique: true, using: :btree
